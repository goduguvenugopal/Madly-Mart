    ...
    <div className='mt-20 px-3 pb-10'>
      <div className='flex justify-center pt-9 mb-7'>
        <div className='relative w-full sm:w-auto'>
          ...
          <input ref={searchRef} value={text} onChange={changeHandling} placeholder="Search for products" type="text" name="text" id="text" className=' w-full h-[3rem] lg:w-96 border-2  py-1.5 pl-12 pr-20 text-gray-900 outline-none border-blue-700 placeholder:text-gray-800   sm:text-md sm:leading-6 placeholder="0.00' />
          <span className='left-4 top-[0.9rem] absolute text-blue-700'><FaSearch size={20} /></span>
        </div>
      </div>

      <h5 className='text-xl font-semibold mt-4'>Search Results : {searchProducts.length}</h5>
